...
<header>
  ...
  <span style="color:var(--cream);font-weight:600;">Drifter</span>
  <span class="badge">v0.1.0</span>
</header>
<main>
  <div class="hero">
    <h1>Drifter</h1>
    <p>API documentation server — write docs in Markdown or OpenAPI, serve as a beautiful hosted page</p>
  </div>
  <div class="stats">
    <div class="stat">
  ...
  <div class="card">
    ...
    <div class="tier-box">
      <div class="tier">
        ...
        <div class="tier-desc">1 project, 10 pages</div>
        <div class="tier-price">$0/mo</div>
      </div>
      <div class="tier pro">
        <div class="tier-name">Pro</div>
        <div class="tier-desc">Unlimited projects and pages</div>
